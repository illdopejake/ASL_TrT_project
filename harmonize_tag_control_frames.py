...
scan_dir = '/Users/jakevogel/bellec_lab/asl_project/asl_scans'
...
matdir = '/Users/jakevogel/bellec_lab/asl_project/asl_scans'
...
output_dir = '/Users/jakevogel/bellec_lab/asl_project/processed'

# When files are recompiled after removing frames, a TR must be specified
tr = 4.22 


def find_true_index_of_delframes(mat,todel):
    ...
    accountz for the fact that removed frames will change the position 
    ...
    if len(mat['time_frames'][0]) != (122 - len(s_frames)):
...
def compare_missing_frames(mat1,mat2):
...
if __name__ == '__main__':
    ...
    for strng in allscnz:
        ...
        del1,del2,fail = compare_missing_frames(mat1,mat2)
        if fail:
        ...
        if len(del1) > 0:
            del1, fail = find_true_index_of_delframes(mat1,del1)
            if fail:
